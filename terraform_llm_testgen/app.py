...
def main():
    ...
    # APP CONFIG
    # ---------------------------
    st.set_page_config(page_title="Terraform Native Test Generator Using GenAI LLM", layout="wide", page_icon="🧱")
    st.title("🧱 Terraform Native Test Generator Using GenAI LLM")
    ...
    provider = st.sidebar.selectbox("Select Cloud Provider", ["Azure", "GCP", "AWS", "Other"])
